...
$userFirstNames = ["Iris", "Liam", "Noah", "Quinn", "Sophie"];
$userLastNames = ["Garcia", "Martinez", "Lee", "Patel", "Walker"];

// List of fictional first and last names for contacts
$contactFirstNames = ["Harper", "Ethan", "Maya", "Lucas", "Chloe"];
$contactLastNames = ["Bennett", "Morgan", "Reed", "Foster", "Parker"];
